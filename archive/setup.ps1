...
Write-Host "Setting up .vibe folder structure..." -ForegroundColor Green

# Create .vibe directory structure
New-Item -ItemType Directory -Path ".vibe" -Force | Out-Null
New-Item -ItemType Directory -Path ".vibe\docs" -Force | Out-Null
...
'@ | Set-Content -Path ".vibe\PERSONA.md" -Force
...
## Confirm
'@ | Set-Content -Path ".vibe\TASKS.md" -Force
...
'@ | Set-Content -Path ".vibe\ERRORS.md" -Force

# Create LINKS.csv
@'
title,url
Claude Documentation, https://docs.anthropic.com/en/docs/claude-code/overview
'@ | Set-Content -Path ".vibe\LINKS.csv" -Force

# Create LOG.txt
New-Item -ItemType File -Path ".vibe\LOG.txt" -Force | Out-Null
...
'@ | Set-Content -Path ".vibe\ENVIRONMENT.md" -Force
...
'@ | Set-Content -Path "CLAUDE.md" -Force

Write-Host "`n✅ .vibe folder structure and CLAUDE.md created successfully!" -ForegroundColor Green
Write-Host ""
Write-Host "Created files:" -ForegroundColor Yellow
Write-Host "  - CLAUDE.md"
Write-Host "  - .vibe\PERSONA.md"
Write-Host "  - .vibe\TASKS.md"
Write-Host "  - .vibe\ERRORS.md"
Write-Host "  - .vibe\LINKS.csv"
Write-Host "  - .vibe\LOG.txt"
Write-Host "  - .vibe\ENVIRONMENT.md"
Write-Host "  - .vibe\docs\ (directory)"